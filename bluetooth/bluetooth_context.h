...
#define G_CALLBACK_CANCELLABLE(METHOD, SENDER, ARG0)                                        \
  static void METHOD ## Thunk(SENDER sender, ARG0 res, gpointer userdata) {                 \
...
class BluetoothContext {
 ...
 private:
  ...
  G_CALLBACK_CANCELLABLE(OnAdapterProxyCreated, GObject*, GAsyncResult*);
  G_CALLBACK_CANCELLABLE(OnDiscoveryStarted, GObject*, GAsyncResult*);
  G_CALLBACK_CANCELLABLE(OnDiscoveryStopped, GObject*, GAsyncResult*);
  G_CALLBACK_CANCELLABLE(OnManagerCreated, GObject*, GAsyncResult*);
  ...
  G_CALLBACK_CANCELLABLE(OnGotDefaultAdapterPath, GObject*, GAsyncResult*);
  G_CALLBACK_CANCELLABLE(OnGotAdapterProperties, GObject*, GAsyncResult*);
  G_CALLBACK_CANCELLABLE(OnAdapterCreateBonding, GObject*, GAsyncResult*);
  G_CALLBACK_CANCELLABLE(OnAdapterDestroyBonding, GObject*, GAsyncResult*);
  G_CALLBACK_CANCELLABLE(OnFoundDevice, GObject*, GAsyncResult*);
  G_CALLBACK_2(OnAdapterPropertySet, GObject*, GAsyncResult*);
  G_CALLBACK_CANCELLABLE(OnDeviceProxyCreated, GObject*, GAsyncResult*);
  G_CALLBACK_CANCELLABLE(OnGotDeviceProperties, GObject*, GAsyncResult*);
  G_CALLBACK_CANCELLABLE(OnServiceProxyCreated, GObject*, GAsyncResult*);
  G_CALLBACK_CANCELLABLE(OnServiceAddRecord, GObject*, GAsyncResult*);
  G_CALLBACK_1(OnListenerAccept, GObject*, GAsyncResult*);
  G_CALLBACK_CANCELLABLE(OnServiceRemoveRecord, GObject*, GAsyncResult*);
